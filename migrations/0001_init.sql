-- Initial migration: create core schema from canonical SQL
\connect chimera

-- Execute the canonical schema file content
-- (This migration is a snapshot of schemas/postgres_schema.sql)
